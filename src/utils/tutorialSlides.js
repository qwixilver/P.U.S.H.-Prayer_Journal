...
const slides = [
    ...
    },
    {
        ...
        body:
            "Add Events to any request to build a chronological timeline of what happened and when. Select 'Add event' from the single view or after tapping on the request name in the daily view",
        cta: "Next"
    },
    {
    ...
    },
    {
        ...
        body:
            "Security view only shows entries marked to show in the security view. This allows you to share specific requests with other people(visually) without sharing your entire journal!",
        cta: "Next"
    },
    {
